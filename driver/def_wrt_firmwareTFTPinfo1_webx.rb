...
*Test_Script_Name*
  def_wrt_firmwareTFTPinfo1

*Test_Case_Number*
  700.200.20.110

*Description*
  Validate the Firmware TFTP Configuration
     - Positive
     - Negative
...
#Launch the Firmware TFTP ruby script
...
begin 
  ...
  g.config.click
  $ie.maximize  
  #Click the Firmware TFTP link on the left side of window
